...
const ChefService = () => {
    return (
        <div style={{backgroundImage : `url(${chefServiceImg})` , backgroundSize: 'cover'}} className="max-w-5xl mx-5 md:mx-10 lg:mx-auto flex justify-center items-center lg:h-80">

            <div className="bg-white text-gray-700 p-4 md:p-10 lg:px-20 text-center m-8 w-10/12">
